...
int copyObjectToActor(int flag2, int var1, int foundName, int16 flag, 
					  int x, int y, int z, int stage, int room, int alpha, 
					  int beta, int gamma, int var2, int var3, int var4, int var5) 
{
	int i;
	int j;
