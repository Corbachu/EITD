...
#if defined(DEBUG_EDGE_WAD)
	const char* a[] = { "EDGE.exe", "-iwad", "darkwar.wad", "-file","bouncing.wad", };
	E_Main(5, a);
#endif 

#if defined(HYPERTENSION)
	const char* a[] = { "EDGE.exe", "-iwad", "hyper.wad", "-file","hod.epk", };
	E_Main(5, a);
#endif 
